$(function() {
    if($('body').data('page') == 'login'){
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["public/dashboard_assets/images/gallery/login4.jpg", "public/dashboard_assets/images/gallery/login3.jpg", "public/dashboard_assets/images/gallery/login2.jpg", "public/dashboard_assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
